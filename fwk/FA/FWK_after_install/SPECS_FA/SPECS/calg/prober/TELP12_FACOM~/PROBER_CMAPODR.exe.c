...
void
_PROBER_CMAPODR(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECINVAR(_in, 1, &Slotstat);
	TPLPUTLASTINVAR(__in, 0, &Cassno);
	TPLPUTLASTINVAR(__in, 1, &Slotstat);
	...
	PROBER_CMAPODR(Cassno,Slotstat,&Status,&Error);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETLASTINVAR(__in, 1, &Slotstat);
