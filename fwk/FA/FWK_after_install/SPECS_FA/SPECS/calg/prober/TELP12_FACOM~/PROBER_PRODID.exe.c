...
void
_PROBER_PRODID(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECOUTVAR(_out, 0, &Prodid);
	TPLGETEXECOUTVAR(_out, 1, &Status);
	TPLGETEXECOUTVAR(_out, 2, &Error);
	TPLPUTLASTOUTVAR(__out, 0, &Prodid);
	...
	/* Algorithm output variable setting */
	TPLPUTEXECOUTVAR(_out, 0, &Prodid);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	/* Algorithm output variable setting */
	TPLGETLASTOUTVAR(__out, 0, &Prodid);
