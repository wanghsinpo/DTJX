...
void
_PROBER_CHKMOVE(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECINVAR(_in, 0, &Xdist);
	TPLGETEXECINVAR(_in, 1, &Ydist);
	TPLPUTLASTINVAR(__in, 0, &Xdist);
	TPLPUTLASTINVAR(__in, 1, &Ydist);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	/* Algorithm input variable setting */
	TPLGETLASTINVAR(__in, 0, &Xdist);
	TPLGETLASTINVAR(__in, 1, &Ydist);
