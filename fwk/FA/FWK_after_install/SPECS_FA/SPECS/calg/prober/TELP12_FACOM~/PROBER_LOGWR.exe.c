...
void
_PROBER_LOGWR(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECINVAR(_in, 0, &Message);
	TPLPUTLASTINVAR(__in, 0, &Message);
	...
	PROBER_LOGWR(Message,&Status,&Error);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	/* Algorithm input variable setting */
	TPLGETLASTINVAR(__in, 0, &Message);
