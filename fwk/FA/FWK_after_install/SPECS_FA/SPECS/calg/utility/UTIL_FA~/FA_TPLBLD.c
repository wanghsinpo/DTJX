...
void
FA_TPLBLD(INTEGER Rev_flag,STRING Brk_chr,STRING Waf_dir,STRING Prb_dir,STRING Die_dir,STRING Tst_dir,STRING Tpl_dir,STRING Waf,STRING Prb,STRING *Die,STRING *Tst,STRING Tpl,INTEGER *Status,STRING *Error,INTEGER *Ndetail,STRING *Detail)
{
