...
void
_SET_SAMELEN20(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLINITMEM(&Original, _TYPES, 20, 0);
	TPLINITMEM(&Modified, _TYPES, 20, 0);
	...
	SET_SAMELEN20(Original,&Modified);
