...
void
_FA_TPL_VERIFY(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECINVAR(_in, 1, &Revmode);
	TPLGETEXECINVAR(_in, 2, &Lib);
	TPLGETEXECINVAR(_in, 3, &Libnum);
	TPLGETEXECINVAR(_in, 4, &Tco);
	TPLGETEXECINVAR(_in, 5, &Tconum);
	TPLGETEXECINVAR(_in, 6, &Tpl);
	TPLGETEXECINVAR(_in, 7, &Delimiter);
	TPLPUTLASTINVAR(__in, 0, &Revcont);
	TPLPUTLASTINVAR(__in, 1, &Revmode);
	TPLPUTLASTINVAR(__in, 2, &Lib);
	TPLPUTLASTINVAR(__in, 3, &Libnum);
	TPLPUTLASTINVAR(__in, 4, &Tco);
	TPLPUTLASTINVAR(__in, 5, &Tconum);
	TPLPUTLASTINVAR(__in, 6, &Tpl);
	TPLPUTLASTINVAR(__in, 7, &Delimiter);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETLASTINVAR(__in, 1, &Revmode);
	TPLGETLASTINVAR(__in, 2, &Lib);
	TPLGETLASTINVAR(__in, 3, &Libnum);
	TPLGETLASTINVAR(__in, 4, &Tco);
	TPLGETLASTINVAR(__in, 5, &Tconum);
	TPLGETLASTINVAR(__in, 6, &Tpl);
	TPLGETLASTINVAR(__in, 7, &Delimiter);
