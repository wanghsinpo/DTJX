...
void
_FA_CHK_REV2(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	FA_CHK_REV2(Session,Kinds,Count,&Status,&Filename,&Rev,&Path,&BasicPath);
