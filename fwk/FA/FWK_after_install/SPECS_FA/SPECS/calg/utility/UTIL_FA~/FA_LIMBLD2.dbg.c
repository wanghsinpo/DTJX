...
void
_FA_LIMBLD2(void *_alg)
{
}

void
__FA_LIMBLD2(void *_alg)
/* _alg points to AlgorithmDefinition */
{
	...
	TPLGETDEBUGINVAR(_in, 4, &Lms_dir);
	TPLGETDEBUGINVAR(_in, 5, &Tpl);
	TPLGETDEBUGINVAR(_in, 6, &Lim);
	TPLGETDEBUGINVAR(_in, 7, &Lms);
