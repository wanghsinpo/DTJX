...
void
_ADD_TAIL_SPACE(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECINVAR(_in, 1, &Length);
	TPLPUTLASTINVAR(__in, 0, &Original);
	TPLPUTLASTINVAR(__in, 1, &Length);
	...
	ADD_TAIL_SPACE(Original,Length,&Modified);
