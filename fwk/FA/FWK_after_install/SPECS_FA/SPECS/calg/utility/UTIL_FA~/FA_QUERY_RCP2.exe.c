...
void
_FA_QUERY_RCP2(void *_alg, void *__alg)
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETEXECOUTVAR(_out, 10, &Mlb);
	TPLGETEXECOUTVAR(_out, 11, &Lt_id);
	TPLGETEXECOUTVAR(_out, 12, &Pt_id);
	TPLGETEXECOUTVAR(_out, 13, &Ps_id);
	TPLGETEXECOUTVAR(_out, 14, &Item);
	TPLGETEXECOUTVAR(_out, 15, &Status);
	TPLGETEXECOUTVAR(_out, 16, &Errmsg);
	...
	TPLPUTLASTOUTVAR(__out, 10, &Mlb);
	TPLPUTLASTOUTVAR(__out, 11, &Lt_id);
	TPLPUTLASTOUTVAR(__out, 12, &Pt_id);
	TPLPUTLASTOUTVAR(__out, 13, &Ps_id);
	TPLPUTLASTOUTVAR(__out, 14, &Item);
	TPLPUTLASTOUTVAR(__out, 15, &Status);
	TPLPUTLASTOUTVAR(__out, 16, &Errmsg);

	/* Algorithm invocation */
	FA_QUERY_RCP2(Key,Filename,&Waf,&Die,&Mod,&Tst,&Prb,&Lms,&Tco,&Tpl,&Lim,&Rcp,&Mlb,&Lt_id,&Pt_id,&Ps_id,&Item,&Status,&Errmsg);
	...
	TPLPUTEXECOUTVAR(_out, 10, &Mlb);
	TPLPUTEXECOUTVAR(_out, 11, &Lt_id);
	TPLPUTEXECOUTVAR(_out, 12, &Pt_id);
	TPLPUTEXECOUTVAR(_out, 13, &Ps_id);
	TPLPUTEXECOUTVAR(_out, 14, &Item);
	TPLPUTEXECOUTVAR(_out, 15, &Status);
	TPLPUTEXECOUTVAR(_out, 16, &Errmsg);
	TPLPUTLASTOUTVAR(__out, 0, &Waf);
	TPLPUTLASTOUTVAR(__out, 1, &Die);
	TPLPUTLASTOUTVAR(__out, 2, &Mod);
	TPLPUTLASTOUTVAR(__out, 3, &Tst);
...
/* __alg points to AlgorithmSpecDefIndexEntry */
{
	...
	TPLGETLASTOUTVAR(__out, 10, &Mlb);
	TPLGETLASTOUTVAR(__out, 11, &Lt_id);
	TPLGETLASTOUTVAR(__out, 12, &Pt_id);
	TPLGETLASTOUTVAR(__out, 13, &Ps_id);
	TPLGETLASTOUTVAR(__out, 14, &Item);
	TPLGETLASTOUTVAR(__out, 15, &Status);
	TPLGETLASTOUTVAR(__out, 16, &Errmsg);
