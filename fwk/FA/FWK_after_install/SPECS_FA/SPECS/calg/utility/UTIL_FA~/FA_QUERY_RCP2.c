...
void
FA_QUERY_RCP2(STRING Key,STRING Filename,STRING *Waf,STRING *Die,STRING *Mod,STRING *Tst,STRING *Prb,STRING *Lms,STRING *Tco,STRING *Tpl,STRING *Lim,STRING *Rcp,STRING *Mlb,STRING *Lt_id,STRING *Pt_id,STRING *Ps_id,STRING *Item,INTEGER *Status,STRING *Errmsg)
{
...
/*===========================================================================*/
    ...
    strcpy(cmd, "/opt/SPECS/usr/recipe/fa_recipe_q2.sh");
    ...
    if (*Status == 0 || *Status == 1) {
        ...
        while (strcmp(line, "# EOD") != 0) {
            if (strncmp(line, "# ", 2) == 0) {
                ...
                else if (strcmp(spc_nm, "MEASLIBS") == 0) {
                    if (n_item >= MLIB_SIZE) {
                        goto Array_overflow;
                    }
                    strcpy(Mlb[n_item], line);
                }
                else {
                    goto No_recipe;
                }
