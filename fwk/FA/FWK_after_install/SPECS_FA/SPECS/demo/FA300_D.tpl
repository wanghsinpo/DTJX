#Test Plan	FA300_D	1	04/02/2009	00:00:00	root	SPECS-FA demonstration test plan (two die & two tests )
...
#Wafer	FA300_D	1	04/02/2009	00:00:00	root	Wafer Spec of SPECS-FA demonstaration
#Die	FA300_B	1	04/02/2009	00:00:00	root	Description for this Die spec.
...
$Name: FA300_D
$Vers: 1
$Desc: Wafer Spec of SPECS-FA demonstaration
$Date: 04/02/2009
$Time: 00:00:00
$User: root
$--------- ------------------- ------------ - - -
...
#                                                                                          
#     BEGIN_NAVI                                                                           
#     SELECT_WAFER FA300_D                                                                 
#     SELECT_PROBE FA300_A                                                                 
#     SELECT_DIE   FA300_B                                                                 
#     SELECT_TEST  FA300_B                                                                 
#     DIE_TEST     FA300_A                                                      FA300_A    
#     DIE_TEST     FA300_B                                                      FA300_B    
#     END_NAVI                                                                             
      SELECT       WAFER,"FA300_D"                                                         
      SELECT       PROBE,"FA300_A"                                                         
      TEST         "FA300_A","FA300_A"                                                     
      TEST         "FA300_B","FA300_B"                                                     
      LOOP                                                                                 
$---- ------------ ------------------------------------------------------------ ------- - -

